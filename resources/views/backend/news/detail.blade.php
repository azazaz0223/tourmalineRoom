                ...
                <div class="d-flex justify-content-start align-items-center gap-3 mb-3">
                    <div class="w-auto col-1">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="mediaType" id="radioBox1" value='1' {{$news->mediaType == 1 ? 'checked' : ''}}>
                            <label class="form-check-label" for="radioBox1">Instagram</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="mediaType" id="radioBox2" value='2' {{$news->mediaType == 2 ? 'checked' : ''}}>
